...
?>
                    <table cellpadding="20" cellspacing="30" border="0" style="background:#ffffff url(images/page.gif);text-align:left;line-height:20px;">
                        ...
                        <tr>
                            ...
                            <td><?php
                    $marks = 0;
                    if (strcmp($_SESSION['q1stdans'], "Chris Gayle") == 0)
                        $marks = $marks + 1;
                    if (strcmp($_SESSION['q2stdans'], "Prof Pradeep Reddy C.H") == 0)
                        $marks = $marks + 1;
                    echo $marks;
?></td>
                        </tr>
                    ...
                    <table cellpadding="30" cellspacing="10" class="datatable">
                        ...
                        <tr>
                            <td>1</td>
                            <td>Who hits the maximum sixes in IPL 2012?</td>
                            <td>Chris Gayle</td>
...
?>
                        ...
                        <tr>
                            <td>2</td>
                            <td>Who takes OSP at VIT uni?</td>
                            <td>Prof Pradeep Reddy C.H</td>
...
?>
                    <div class="tc">
                        ...
                        <textarea cols="100" rows="8" name="question" readonly style="width:96.8%;text-align:left;margin-left:2%;margin-top:2px;font-size:120%;font-weight:bold;margin-bottom:0;color:#0000ff;padding:2px 2px 2px 2px;">Who takes OSP at VIT uni?</textarea>
                        <table border="0" width="100%" class="ntab">
                            <tr><td>&nbsp;</td></tr>
                            <tr><td >1. <input type="radio" name="answer" value="Prof Jayenthi N" <?php if ((strcmp($_SESSION['q2status'], "review") == 0 || strcmp($_SESSION['q2status'], "answered") == 0) && strcmp($_SESSION['q2stdans'], "Prof Jayenthi N") == 0) {
                                echo "checked";
                            } ?>>
                              Prof Jeyanthi N</td>
                            </tr>
                                <tr><td >2. <input type="radio" name="answer" value="Prof Usha Devi G" <?php if ((strcmp($_SESSION['q2status'], "review") == 0 || strcmp($_SESSION['q2status'], "answered") == 0) && strcmp($_SESSION['q2stdans'], "Prof UshaDevi G") == 0) {
                                echo "checked";
                            } ?>>
                                  Prof Usha Devi G</td>
                                </tr>
                                    <tr><td >3. <input type="radio" name="answer" value="Prof Pradeep Reddy C.H" <?php if ((strcmp($_SESSION['q2status'], "review") == 0 || strcmp($_SESSION['q2status'], "answered") == 0) && strcmp($_SESSION['q2stdans'], "Prof Pradeep Reddy C.H") == 0) {
                                echo "checked";
                            } ?>>
                                      Prof Pradeep Reddy C.H</td>
                                    </tr>
                                    <tr><td >4. <input type="radio" name="answer" value="Prof Manivanan S.S" <?php if ((strcmp($_SESSION['q2status'], "review") == 0 || strcmp($_SESSION['q2status'], "answered") == 0) && strcmp($_SESSION['q2stdans'], "Prof Manivanan S.S") == 0) {
                                echo "checked";
                            } ?>>
                                      Prof Manivanan S.S </td>
                                    </tr>
                                    <tr><td>&nbsp;</td></tr>
                                    <tr>
...
?>
                            <div class="tc">
                                ...
                                <textarea cols="100" rows="8" name="question" readonly style="width:96.8%;text-align:left;margin-left:2%;margin-top:2px;font-size:120%;font-weight:bold;margin-bottom:0;color:#0000ff;padding:2px 2px 2px 2px;">Who hits the maximum sixes in IPL 2012?</textarea>
                                <table border="0" width="100%" class="ntab">
                                    <tr><td>&nbsp;</td></tr>
                                    <tr><td >1. <input type="radio" name="answer" value="ST Jayasuriya" <?php if ((strcmp($_SESSION['q1status'], "review") == 0 || strcmp($_SESSION['q1status'], "answered") == 0) && strcmp($_SESSION['q1stdans'], "ST Jayasuriya") == 0) {
                                echo "checked";
                            } ?>>
                                      ST Jayasuriya</td>
                                    </tr>
                                    <tr><td >2. <input type="radio" name="answer" value="Yusuf Pathan" <?php if ((strcmp($_SESSION['q1status'], "review") == 0 || strcmp($_SESSION['q1status'], "answered") == 0) && strcmp($_SESSION['q1stdans'], "Yusuf Pathan") == 0) {
                                echo "checked";
                            } ?>>
                                      Yusuf Pathan </td>
                                    </tr>
                                    <tr><td >3. <input type="radio" name="answer" value="MS Dhoni" <?php if ((strcmp($_SESSION['q1status'], "review") == 0 || strcmp($_SESSION['q1status'], "answered") == 0) && strcmp($_SESSION['q1stdans'], "MS Dhoni") == 0) {
                                echo "checked";
                            } ?>>
                                      MS Dhoni </td>
                                    </tr>
                                    <tr><td >4. <input type="radio" name="answer" value="Chris Gayle" <?php if ((strcmp($_SESSION['q1status'], "review") == 0 || strcmp($_SESSION['q1status'], "answered") == 0) && strcmp($_SESSION['q1stdans'], "Chris Gayle") == 0) {
                                echo "checked";
                            } ?>>
                                      Chris Gayle </td>
                                    </tr>
