...
<html>
  <head>
    <title>VEQ-Test Conducter</title>
  ...
  <body >
      ...
      <div class="header">
          ...
          <div class="menubar" style="text-align:center;">
              <h2 style="font-family:helvetica,sans-serif;font-weight:bolder;font-size:120%;color:#f50000;padding-top:0.3em;letter-spacing:1px;">VEQ</h2>
          </div>
      <div class="page">
          <?php
